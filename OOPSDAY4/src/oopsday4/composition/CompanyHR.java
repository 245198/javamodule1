...
public class CompanyHR {
	...
	public static void main(String[] args) 
	{
		 ...
		 */
		 ...
		 Address resAdd = new Address("31","Mannath","Mumbai","valley", 400000); 
		 Address commAdd = new Address("32","Antela","Bandra","valley", 89900);
		
		Employee emp1 = new Employee("John Doe","Male",24,101,"Research",14000,resAdd,commAdd);
		System.out.println(emp1);
		Employee emp2 = new Employee("Jane Doe","Female",23,102,"Accounting",17000,resAdd,commAdd);
		System.out.println(emp2);
		Employee emp3 = new Employee("Aneeta Roy","Female",22,103,"Sales",35000,resAdd,commAdd);
		System.out.println(emp3);
		Employee emp4 = new Employee("Hari","Male",24,104,"Research",89000,resAdd,commAdd);
		System.out.println(emp4);
		Employee emp5 = new Employee("John Doe","Male",24,101,"Research",14000,resAdd,commAdd);
